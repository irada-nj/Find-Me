            ...
            if (bundle != null) {
                ...
                if (messages.length > -1) {
                    ...
                    if(messageBody.contains("findme")){
                        NotificationCompat.Builder mbuilder=new NotificationCompat.Builder(context , "CHANNEL_FINDME");
                       ...
                       // lazmna pending intent khtr setcontentintent t7eb objet haka w on_shot ma3naha mara bark tetlasa activity
